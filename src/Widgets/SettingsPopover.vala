...
public class Audience.Widgets.SettingsPopover : Gtk.Popover {
    ...
    public SettingsPopover (Gtk.Widget widget) {
        ...
        var lang_lbl   = new Gtk.Label (_("Audio:"));
        lang_lbl.halign = Gtk.Align.END;
        var sub_lbl    = new Gtk.Label (_("Subtitles:"));
        sub_lbl.halign = Gtk.Align.END;
        var sub_ext_lbl = new Gtk.Label (_("External Subtitles:"));
        sub_ext_lbl.halign = Gtk.Align.END;
